...
function input_dados2(entrada2){
...
function main (){
    ...
    const sexo = input_dados2('Digite Seu sexo (M) para masculino ou (F) para feminino: ') //entrada para string
    
    //processamento
    const tmb_feminino = tmb_mulher(peso, altura, idade)

    //saida
    print(` ->Peso: ${peso}\n ->Altura: ${altura}\n ->Idade: ${idade}\n ->Sexo: ${sexo}\n A taxa metabolica de uma mulher com as caracteristicas definidas anteriormente são: ${Math.floor(tmb_feminino)}.`)
}
